...
names.forEach(function(friends){ // this (forEach) loop will print names one by one 
    console.log(friends)
});
...
names.forEach(function(msg){ // this will print statements to names one by one
...
transportation.forEach(function(examples){ // this will print statements one by one
...
guestList.forEach(function(invitation){ // this will print statements to the guests one by one
