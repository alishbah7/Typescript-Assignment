...
let Name: string = "Alishbah" // the name is stored this variable
console.log(`Hello ${Name}, would you like to learn some Python today?`); 

//---======== 3 ========---://
//Name Cases: Store a person’s name in a variable, and then print that person’s name in lowercase, uppercase, and titlecase.

let personName:string = "alishbah muhammad kamran" // the name is stored this variable
...
let favouriteNumber: number = 3 // this variable contains number
let numberMessage: string = `My favourite number is ${favouriteNumber}` // this variable contains statement
